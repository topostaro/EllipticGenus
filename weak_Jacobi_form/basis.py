...
def _phi_tilde_0_1():
    ...
    EXAMPLE:
        ...
        sage: from sage.EllipticGenus.weak_Jacobi_form.basis import _phi_tilde_0_1
        sage: _phi_tilde_0_1()
...
def _phi_tilde_m2_1():
    ...
    EXAMPLE:
        ...
        sage: from sage.EllipticGenus.weak_Jacobi_form.basis import _phi_tilde_m2_1
        sage: _phi_tilde_m2_1()
        (y^-1 - 2 + y) + (-2*y^-2 + 8*y^-1 - 12 + 8*y - 2*y^2)*q + (y^-3 - 12*y^-2 + 39*y^-1 - 56 + 39*y - 12*y^2 + y^3)*q^2 + (8*y^-3 - 56*y^-2 + 152*y^-1 - 208 + 152*y - 56*y^2 + 8*y^3)*q^3 + (-2*y^-4 + 39*y^-3 - 208*y^-2 + 513*y^-1 - 684 + 513*y - 208*y^2 + 39*y^3 - 2*y^4)*q^4 + (-12*y^-4 + 152*y^-3 - 684*y^-2 + 1560*y^-1 - 2032 + 1560*y - 684*y^2 + 152*y^3 - 12*y^4)*q^5 + (y^-5 - 56*y^-4 + 513*y^-3 - 2032*y^-2 + 4382*y^-1 - 5616 + 4382*y - 2032*y^2 + 513*y^3 - 56*y^4 + y^5)*q^6 + O(q^7)
...
def _phi_tilde_0_3o2():
    ...
    EXAMPLE:
        ...
        sage: from sage.EllipticGenus.weak_Jacobi_form.basis import _phi_tilde_0_3o2
...
def basis_integral(weight: int, index: int) -> list:
    ...
    The list consisting of series in a basis of weight``weight`` and index ``index``.

    EXAMPLES::

        sage: from sage.EllipticGenus.weak_Jacobi_form.basis import basis_integral
        sage: basis_integral(0, 1)
        [(y^-1 + 10 + y) + (10*y^-2 - 64*y^-1 + 108 - 64*y + 10*y^2)*q + (y^-3 + 108*y^-2 - 513*y^-1 + 808 - 513*y + 108*y^2 + y^3)*q^2 + (-64*y^-3 + 808*y^-2 - 2752*y^-1 + 4016 - 2752*y + 808*y^2 - 64*y^3)*q^3 + (10*y^-4 - 513*y^-3 + 4016*y^-2 - 11775*y^-1 + 16524 - 11775*y + 4016*y^2 - 513*y^3 + 10*y^4)*q^4 + (108*y^-4 - 2752*y^-3 + 16524*y^-2 - 43200*y^-1 + 58640 - 43200*y + 16524*y^2 - 2752*y^3 + 108*y^4)*q^5 + (y^-5 + 808*y^-4 - 11775*y^-3 + 58640*y^-2 - 141826*y^-1 + 188304 - 141826*y + 58640*y^2 - 11775*y^3 + 808*y^4 + y^5)*q^6 + O(q^7)]
        sage: basis_integral(0, 3)
        ...
        sage: basis_integral(4, 1)
        [(y^-1 + 10 + y) + (10*y^-2 + 176*y^-1 + 2508 + 176*y + 10*y^2)*q + (y^-3 + 2508*y^-2 - 13713*y^-1 + 48328 - 13713*y + 2508*y^2 + y^3)*q^2 + (176*y^-3 + 48328*y^-2 - 257392*y^-1 + 498416 - 257392*y + 48328*y^2 + 176*y^3)*q^3 + (10*y^-4 - 13713*y^-3 + 498416*y^-2 - 2192895*y^-1 + 3626604 - 2192895*y + 498416*y^2 - 13713*y^3 + 10*y^4)*q^4 + (2508*y^-4 - 257392*y^-3 + 3626604*y^-2 - 13351920*y^-1 + 20323280 - 13351920*y + 3626604*y^2 - 257392*y^3 + 2508*y^4)*q^5 + (y^-5 + 48328*y^-4 - 2192895*y^-3 + 20323280*y^-2 - 65299906*y^-1 + 94968144 - 65299906*y + 20323280*y^2 - 2192895*y^3 + 48328*y^4 + y^5)*q^6 + O(q^7),
         (y^-1 - 2 + y) + (-2*y^-2 - 496*y^-1 + 996 - 496*y - 2*y^2)*q + (y^-3 + 996*y^-2 - 20625*y^-1 + 39256 - 20625*y + 996*y^2 + y^3)*q^2 + (-496*y^-3 + 39256*y^-2 - 275536*y^-1 + 473552 - 275536*y + 39256*y^2 - 496*y^3)*q^3 + (-2*y^-4 - 20625*y^-3 + 473552*y^-2 - 2241279*y^-1 + 3576708 - 2241279*y + 473552*y^2 - 20625*y^3 - 2*y^4)*q^4 + (996*y^-4 - 275536*y^-3 + 3576708*y^-2 - 13418448*y^-1 + 20232560 - 13418448*y + 3576708*y^2 - 275536*y^3 + 996*y^4)*q^5 + (y^-5 + 39256*y^-4 - 2241279*y^-3 + 20232560*y^-2 - 65445058*y^-1 + 94829040 - 65445058*y + 20232560*y^2 - 2241279*y^3 + 39256*y^4 + y^5)*q^6 + O(q^7)]
        sage: basis_integral(-2, 1)
        [(y^-1 - 2 + y) + (-2*y^-2 + 8*y^-1 - 12 + 8*y - 2*y^2)*q + (y^-3 - 12*y^-2 + 39*y^-1 - 56 + 39*y - 12*y^2 + y^3)*q^2 + (8*y^-3 - 56*y^-2 + 152*y^-1 - 208 + 152*y - 56*y^2 + 8*y^3)*q^3 + (-2*y^-4 + 39*y^-3 - 208*y^-2 + 513*y^-1 - 684 + 513*y - 208*y^2 + 39*y^3 - 2*y^4)*q^4 + (-12*y^-4 + 152*y^-3 - 684*y^-2 + 1560*y^-1 - 2032 + 1560*y - 684*y^2 + 152*y^3 - 12*y^4)*q^5 + (y^-5 - 56*y^-4 + 513*y^-3 - 2032*y^-2 + 4382*y^-1 - 5616 + 4382*y - 2032*y^2 + 513*y^3 - 56*y^4 + y^5)*q^6 + O(q^7)]
